            ...
            <div className="bg-surface-raised border border-rose-500/30 rounded-2xl p-6 max-w-md w-full shadow-2xl space-y-4 animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="space-y-3">
                    <p className="text-xs text-on-surface leading-relaxed">
                        Êtes-vous absolument sûr de vouloir supprimer la ligne <strong className="text-white px-1.5 py-0.5 rounded bg-surface border border-edge">{rule.label}</strong> ?
                    </p>
                    
                    <div className="p-3.5 bg-rose-950/30 border border-rose-500/20 rounded-xl space-y-1.5">
                        <p className="text-[11px] font-semibold text-rose-300 flex items-center gap-1.5 uppercase tracking-wide">
                ...
                <div className="flex items-center justify-end space-x-3 pt-3 border-t border-edge">
                    <button
                        ...
                        onClick={onClose}
                        disabled={isDeleting}
                        className="px-4 py-2 rounded-xl bg-surface-elevated text-on-surface-secondary hover:text-white text-xs font-medium transition-colors cursor-pointer disabled:opacity-50"
                    >
                        Annuler
                    </button>
                    <button
